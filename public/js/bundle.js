...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mainMainJsx = __webpack_require__(1);
	
	var _mainMainJsx2 = _interopRequireDefault(_mainMainJsx);
	...
	_reactDom2['default'].render(_react2['default'].createElement(_mainMainJsx2['default'], null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _filtr_butFiltr_but = __webpack_require__(160);
	
	var _filtr_butFiltr_but2 = _interopRequireDefault(_filtr_butFiltr_but);
	
	var _filtrFiltr = __webpack_require__(161);
	
	var _filtrFiltr2 = _interopRequireDefault(_filtrFiltr);
		...
		_createClass(App, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					'div',
					{ className: 'container' },
					_react2['default'].createElement(_filtr_butFiltr_but2['default'], null),
					_react2['default'].createElement(_filtrFiltr2['default'], null)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FiltrBut = (function (_React$Component) {
		_inherits(FiltrBut, _React$Component);
	
		function FiltrBut() {
			var _this = this;
	
			_classCallCheck(this, FiltrBut);
	
			_get(Object.getPrototypeOf(FiltrBut.prototype), 'constructor', this).call(this);
			...
			this.click = function () {
				...
				if (_this.state.clickCheck) {
					f.style.display = 'none';
					c.className = 'content_normal';
					b.className = '';
					_this.setState({ clickCheck: false });
				} else {
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'a',
						{ className: 'filtr_but', onClick: this.click },
						'Фильтр'
					),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _contentContent = __webpack_require__(162);
	
	var _contentContent2 = _interopRequireDefault(_contentContent);
	
	var _inputInput = __webpack_require__(164);
	...
	var Filter = (function (_React$Component) {
		...
		function Filter() {
			...
			this.getNumbers = function (a, b) {
				_this.setFiltr('min', a);
				_this.setFiltr('max', b);
				_this.returnRenterCount();
			};
	
			this.check = function (c) {
				_this.setFiltr('diskont', c);
				_this.returnRenterCount();
			};
	
			this.getCount = function (count) {
				_this.setFiltr('count', count);
				_this.returnRenterCount();
			};
	
			this.getName = function (name) {
				_this.setFiltr('name', name);
				_this.returnRenterCount();
			};
	
			this.setFiltr = function (key, val) {
				var currentObj = _this.state.locationFiltr;
				currentObj[key] = val;
				_this.setState({ locationFiltr: currentObj });
				history.pushState(null, null, '/' + _this.setUrl(currentObj));
			};
			...
			this.showMore = function () {
				...
				_this.setFiltr('renderCount', currentObj['renderCount']);
			};
	
			this.returnRenterCount = function () {
				_this.setFiltr('renderCount', 3);
			};
		...
		_createClass(Filter, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					'div',
					{ className: 'filtr' },
					_react2['default'].createElement(_inputInput2['default'], { getNumbers: this.getNumbers, check: this.check, setName: this.getName, setCount: this.getCount, filtrObject: this.state.locationFiltr, getUrl: this.getUrl }),
					_react2['default'].createElement(_contentContent2['default'], { filtrObject: this.state.locationFiltr, setFiltr: this.setFiltr }),
					_react2['default'].createElement(
						'div',
						{ className: 'show_cont' },
						_react2['default'].createElement(
							'a',
							{ id: 'show_but', onClick: this.showMore },
							'Показать еще'
						)
					)
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _elementElement = __webpack_require__(163);
	
	var _elementElement2 = _interopRequireDefault(_elementElement);
	
	var _inputInputJsx = __webpack_require__(164);
	
	var _inputInputJsx2 = _interopRequireDefault(_inputInputJsx);
	
	var _filtrFiltrJsx = __webpack_require__(161);
	
	var _filtrFiltrJsx2 = _interopRequireDefault(_filtrFiltrJsx);
	...
	var Content = (function (_React$Component) {
			...
			function Content() {
					...
					this.componentWillMount = function () {
							// call ajax request
							_this.ajax('http://localhost:3000/products/');
					};
	
					this.componentDidUpdate = function () {
							// show/hint button
							if (_this.props.filtrObject.renderCount > _this.defaultProps.i || _this.props.filtrObject.renderCount >= _this.state.data.products.length) {
									document.getElementById('show_but').style.display = 'none';
							} else {
									document.getElementById('show_but').style.display = 'inline';
							}
							if (_this.defaultProps.i == 0) {
					...
					this.calculateFiltr = function () {
							//fields filtration
							var min = _this.props.filtrObject.min;
							var max = _this.props.filtrObject.max,
							    mount_content = _this.state.data.products;
							_this.defaultProps.i = 0;
							var filtr = mount_content.map(function (datum) {
									if (_this.defaultProps.i < _this.props.filtrObject.renderCount) {
											if (datum.deals == _this.props.filtrObject.diskont || !_this.props.filtrObject.diskont) {
													if (datum.count == _this.props.filtrObject.count || !_this.props.filtrObject.count) {
															if (datum.price < max && datum.price > min || !_this.props.filtrObject.max) {
																	if (datum.price > min || !_this.props.filtrObject.min) {
																			if (datum.name.indexOf(_this.props.filtrObject.name) + 1 || !_this.props.filtrObject.name) {
																					++_this.defaultProps.i;
																					return _react2['default'].createElement(_elementElement2['default'], { name: datum.name, img_s: datum.img, price: datum.price, count: datum.count, deal: datum.deals });
																			}
																	}
															}
													}
			...
			_createClass(Content, [{
					...
					value: function render() {
							return _react2['default'].createElement(
									'div',
									{ id: 'content', className: 'content_normal' },
									this.calculateFiltr(),
									_react2['default'].createElement(
											'div',
											{ id: 'hint' },
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							'div',
							{ className: 'img_div' },
							_react2['default'].createElement('img', { src: this.props.img_s, className: 'elem_img' })
						),
						_react2['default'].createElement(
							'div',
							{ className: 'el_count' },
						...
						_react2['default'].createElement(
							'div',
							{ className: 'el_discont' },
							'Скидка: ',
							this.props.deal ? 'Есть ' : 'Нет'
						),
						_react2['default'].createElement(
							'h5',
							{ className: 'elem_price' },
							'Цена: ',
							this.props.price
						)
					)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Input = (function (_React$Component) {
		...
		function Input() {
			...
			this.min_seach = function (e) {
				//validation min value
				var v = _this.validation(e);
				if (_this.state.max && parseFloat(v) > _this.state.max) {
					e.target.value = _this.state.max - 0.01;
					_this.setState({ min: _this.state.max - 0.01 });
					_this.props.getNumbers(_this.state.max - 0.01, _this.state.max);
					e.target.className = 'valid';
				} else {
					if (v) {
						e.target.className = 'valid';
						_this.setState({ min: v });
						_this.props.getNumbers(v, _this.state.max);
					} else {
						_this.setState({ min: '' });
						e.target.className = '';
						if (_this.state.max) {
							_this.props.getNumbers(0, _this.state.max);
						}
					}
				}
			};
			...
			this.max = function (e) {
				...
				var max = _this.validation(e),
				    min = _this.state.min;
				if (parseFloat(max) >= parseFloat(min)) {
					e.target.className = 'valid';
					_this.props.getNumbers(min, max);
			...
			this.clearDefaultVal = function (e) {
				// clear inputs
			...
			this.check = function () {
				...
				if (document.getElementById('deal_input').checked) {
					_this.props.check(true);
				} else {
					_this.props.check(false);
				}
			};
	
			this.componentDidMount = function () {
				// view values from url after restarting a page
				document.getElementById('deal_input').checked = _this.props.filtrObject.diskont;
				_this.setRestartSettings('max', 'max');
				_this.setRestartSettings('min', 'min');
				_this.setRestartSettings('s_input', 'name');
				_this.setRestartSettings('c_input', 'count');
				_this.setState({
					max: _this.props.filtrObject.max,
					min: _this.props.filtrObject.min,
					name: _this.props.filtrObject.name,
					count: _this.props.filtrObject.count
				});
			};
	
			this.setRestartSettings = function (path, val) {
				document.getElementById(path).value = _this.props.filtrObject[val];
			};
		...
		_createClass(Input, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement('input', { type: 'text', id: 'min', step: '0.01', placeholder: 'от', value: this.state.min, onChange: this.min_seach, onFocus: this.clearDefaultVal }),
					_react2['default'].createElement(
						'span',
						{ className: 'to' },
						' : '
					),
					_react2['default'].createElement('input', { type: 'text', step: '0.01', id: 'max', placeholder: 'до', value: this.state.max, onChange: this.max, onFocus: this.clearDefaultVal }),
					_react2['default'].createElement(
						'div',
						{ className: 'secLab' },
						_react2['default'].createElement(
					...
					_react2['default'].createElement('input', { type: 'checkbox', id: 'deal_input', onClick: this.check }),
					_react2['default'].createElement(
						'div',
						null,
						_react2['default'].createElement(
					...
					_react2['default'].createElement('input', { type: 'text', id: 's_input', maxLength: '15', onChange: this.getName }),
					_react2['default'].createElement(
						'div',
						{ className: 'secLab' },
						_react2['default'].createElement(
					...
					_react2['default'].createElement('input', { type: 'number', step: 'any', maxLength: '15', onChange: this.getCount, id: 'c_input' })
				);
			}
		}]);
